...
Builds a 100-card Commander deck from your ManaBox collection export using Scryfall card data, heuristic role-filling, and an optional Claude AI review pass. Also exposes its core functions as MCP server tools so Claude can call them directly and iterate on decks conversationally.

## Features

- Parses a ManaBox CSV export and enriches every card with Scryfall data (type, oracle text, keywords, CMC, legalities)
...
├── deck_builder.py  # 99-card deck construction and synergy scoring
